 ...
 */
public abstract class FirebaseFilterableRecyclerAdapter<T, VH extends RecyclerView.ViewHolder>
        extends RecyclerView.Adapter<VH> implements FirebaseHelperAdapter<T>, Filterable {
     ...
     */
    public FirebaseFilterableRecyclerAdapter(FirebaseRecyclerOptions<T> options, boolean isFiltarable) {
